...
\begin{itemize}
    ...
    \itembox Interference: When in future making some test, do an opposed \skill{WIL} vs. \skill[+30]{Infection} before that. If infection wins, player suffers critical failure. Preferably during dramatic situations.
