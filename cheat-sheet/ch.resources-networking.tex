...
\begin{eptable}{ l | X}
   \rndheader{2}{Ways to Acquire Gear}
...
\begin{eptable}{ l | X}
   \rndheader{2}{Acquisition Time Frame}
   Digital Only & \num{1} minute.\\
   Minor & \num{2} hours.\\
   Moderate & \num{8} hours.\\
   Major & \num{24} hours.\\
...
\begin{eptable}{ l | l | X}
   \rndheader{3}{Rep Refresh \& Burning }
